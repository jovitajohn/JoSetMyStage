         ...
         navigation.setOptions({ headerShown: true,
                                ...
                                headerTitle: () => (
                                  <View style={{ flexDirection: 'row',  justifyContent: 'space-between', width: '100%' }}>
                                    <Text style={{ fontSize: 18, fontWeight: 'bold',  flex: 1 }}>Venue Detail</Text>
                                    <Icon
                 ...
                 <View style={styles.cardDetail}>
                  <ScrollView >
                     ...
                     <View style={styles.card}>
                       ...
                       <Text style={styles.cardDescription}>Price : 20/H</Text>
                       <Text style={styles.cardDescription}>Working Hours : 10:00 AM - 7:00PM</Text>
                       <Text style={styles.cardDescription}>Location : 1 Festival Sq, Edinburgh EH3 9SR</Text>
